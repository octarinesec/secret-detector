...
import (
	"encoding/json"
	"github.com/octarinesec/secret-detector/pkg/transformers/command"
	"io"
	...
	"github.com/octarinesec/secret-detector/pkg/detectors/azure"
	"github.com/octarinesec/secret-detector/pkg/detectors/basicauth"
	"github.com/octarinesec/secret-detector/pkg/detectors/bearerauth"
	"github.com/octarinesec/secret-detector/pkg/detectors/generic"
	"github.com/octarinesec/secret-detector/pkg/detectors/github"
	"github.com/octarinesec/secret-detector/pkg/detectors/jwt"
	"github.com/octarinesec/secret-detector/pkg/detectors/keyword"
	"github.com/octarinesec/secret-detector/pkg/detectors/mailchimp"
	"github.com/octarinesec/secret-detector/pkg/detectors/npm"
	"github.com/octarinesec/secret-detector/pkg/detectors/privatekey"
	"github.com/octarinesec/secret-detector/pkg/detectors/sendgrid"
	"github.com/octarinesec/secret-detector/pkg/detectors/slack"
	"github.com/octarinesec/secret-detector/pkg/detectors/square"
	"github.com/octarinesec/secret-detector/pkg/detectors/stripe"
	"github.com/octarinesec/secret-detector/pkg/detectors/twilio"
	"github.com/octarinesec/secret-detector/pkg/transformers/initransformer"
	"github.com/octarinesec/secret-detector/pkg/transformers/jsontransformer"
	"github.com/octarinesec/secret-detector/pkg/transformers/xmltransformer"
	"github.com/octarinesec/secret-detector/pkg/transformers/yamltransformer"
)
